...
const NavServices:React.FC<NavServicesProps> = ({ activeSection, handleSection }) => {
  const [showNav, setShowNav] = useState(false);
  // const [activeSection, setSectionActive] = useState(1);

  const toggleNav = () => {
    setShowNav(!showNav);
  };

  // const handleSection = (section: number, path: string) => {
  ...
  return (
    ...
    >
      <button
        className="p-2 bg-white shadow-md rounded-tl-md rounded-bl-md aspect-square justify-center items-center flex z-[1]"
        onClick={toggleNav}
      >
        <svg
      ...
      <div
        className={`duration-700 transform bg-white rounded-tl-md flex flex-col rounded-bl-md px-3 py-4 gap-4 shadow-md`}
      >
        {/* mk */}
        <button
          className=" rounded-md aspect-square justify-center items-center shadow p-1.5"
        ...
        >
          ...
          >
            <path
              ...
              fill={activeSection === "#marketing-digital" ? "#a52de6" : "#888888"}
            />
            <path
        ...
        >
          ...
          >
            <path
              ...
              fill={activeSection === "#desarrollo-software" ? "#007cf8" : "#888888"}
            />
          </svg>
        </button>
        {/* branding */}
        ...
        >
          ...
          >
            <path
              ...
              fill={activeSection === "#desarrollo-movil" ? "#007cf8" : "#888888"}
            />
          </svg>
        </button>
        {/* email mk */}
        <button
          className=" rounded-md aspect-square justify-center items-center shadow p-1.5"
          onClick={() => handleSection("#mail-marketing")}
        >
          <svg
            width="24"
            height="24"
          ...
          >
            <path
              ...
              fill={activeSection === "#mail-marketing" ? "#a52de6" : "#888888"}
            />
            <path
