...
type NavServicesProps = {
  activeSection: string | null;
  handleSection: (sectionId: string) => void;
};
const NavServices: React.FC<NavServicesProps> = ({
  ...
  return (
    <div
      className={`fixed top-1/4 right-0  z-10 flex flex-row justify-center items-center transform duration-700 ${
        showNav ? "translate-x-0" : "translate-x-[60px]"
      }`}
    >
      <button
        className={`p-2 bg-white shadow-[-5px_0px_17px_2px_rgba(0,0,0,0.09)] rounded-tl-md rounded-bl-md aspect-square justify-center items-center flex z-[1]`}
        onClick={toggleNav}
      >
        <svg
          className={`transform duration-700  ${showNav ? "rotate-180" : ""}`}
          width="16"
          height="18"
          viewBox="0 0 26 24"
          fill="none"
        ...
        >
          <path
            d="M0.585709 10.588C-0.195236 11.369 -0.195236 12.6373 0.585709 13.4182L10.5818 23.4143C11.3627 24.1952 12.631 24.1952 13.4119 23.4143C14.1929 22.6333 14.1929 21.3651 13.4119 20.5841L4.8278 12L13.4057 3.41585C14.1866 2.63491 14.1866 1.36665 13.4057 0.585709C12.6248 -0.195236 11.3565 -0.195236 10.5756 0.585709L0.579461 10.5818L0.585709 10.588ZM22.5771 0.591956L12.581 10.588C11.8001 11.369 11.8001 12.6373 12.581 13.4182L22.5771 23.4143C23.3581 24.1952 24.6263 24.1952 25.4073 23.4143C26.1882 22.6333 26.1882 21.3651 25.4073 20.5841L16.8231 12L25.401 3.41585C26.182 2.63491 26.182 1.36665 25.401 0.585709C24.6201 -0.195236 23.3518 -0.195236 22.5709 0.585709L22.5771 0.591956Z"
            fill="#888888"
          />
        </svg>
      </button>
      <div
        className={`duration-700 transform bg-white rounded-tl-md flex flex-col rounded-bl-md px-3 py-4 gap-4 shadow-[-5px_0px_17px_2px_rgba(0,0,0,0.09)]`}
      >
        {/* mk */}
        <button
          style={{
          ...
          className={`rounded-md aspect-square justify-center items-center ${
        ...
        >
          ...
          >
            <path
              ...
              fill={
                activeSection === "#marketing-digital" ? "#a52de6" : "#888888"
              }
            />
            <path
        ...
        >
          ...
          >
            <path
              ...
              fill={activeSection === "#diseno-web" ? "#0bc2e1" : "#888888"}
            />
            <path
        ...
        >
          ...
          >
            <path
              ...
              fill={
                activeSection === "#desarrollo-software" ? "#007cf8" : "#888888"
              }
            />
          </svg>
        </button>
        ...
        >
          ...
          >
            <path
              ...
              fill={
                activeSection === "#desarrollo-movil" ? "#007cf8" : "#888888"
              }
            />
          </svg>
        </button>
        ...
        >
          ...
          >
            <path
              ...
              fill={
                activeSection === "#email-marketing" ? "#a52de6" : "#888888"
              }
            />
            <path
