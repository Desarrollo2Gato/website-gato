...
const ConfirmationModal: React.FC<ConfirmationModalProps> = ({
  ...
  function redirect() {
    if (isJob) {
      window.open("https://wa.me/+51956254905", "_blank");
    } else {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white rounded-lg p-8 max-w-[80%] w-full lg:max-w-[400px]  ">
        ...
        <div className="flex justify-end mt-8 items-center gap-2">
          ...
          <button
            className="bg-[#4608AD] text-white px-4 py-2 rounded transition-all duration-300 hover:bg-[#4C03BE]"
            onClick={onClose}
          >
            Cerrar
          </button>
