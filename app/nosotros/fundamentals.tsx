            ...
            <div className="h-full w-full flex flex-col gap-4 items-center justify-between text-[#3D3D3D]">
              <RevealWrapper origin="left" duration={1500}>
                <div className="flex flex-col gap-4">
                  <div className="w-[80px] h-auto aspect-square rounded-full shadow-md bg-[#4608AD] flex justify-center items-center ">
                    <svg
              ...
              <RevealWrapper origin="left" duration={1500}>
                <div className="flex flex-col gap-4 justify-between h-full">
                  <p className="w-full text-center">
                    ...
                    soluciones innovadoras que inspiren confianza y admiración
          ...
          <div className={`w-full lg:w-1/3 lg:max-w-[350px]`}>
            <div className="h-full w-full flex flex-col gap-4 items-center justify-between text-[#3D3D3D]">
                ...
                <div className="flex flex-col gap-4">
                  <div className="w-[80px] h-auto aspect-square rounded-full shadow-md bg-[#4608AD] flex justify-center items-center ">
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <g clipPath="url(#clip0_1828_1484)">
                        <path
              ...
              <RevealWrapper origin="left" duration={1500}>
                <div className="flex flex-col gap-4 justify-between h-full">
                  <p className="text-center">
                    En GATO, se valora la confianza y la creatividad como
                    pilares fundamentales. Se busca mantener la integridad y la
